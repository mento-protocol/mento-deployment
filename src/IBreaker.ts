...
export interface IBreakerInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "getCooldown" | "shouldReset" | "shouldTrigger"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "shouldReset",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "shouldTrigger",
    values: [PromiseOrValue<string>]
  ): string;
...
export interface IBreaker extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber] & { cooldown: BigNumber }>;
