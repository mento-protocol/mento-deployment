...
contract cINRChecksBase is GovernanceScript, Test {
  using TradingLimits for TradingLimits.Config;
  using FixidityLib for FixidityLib.Fraction;
  using SafeMath for uint256;

  address public cUSD;
  address payable public cINR;
  ...
  function setUp() public {
    ...
    contracts.loadSilent("cINR-00-Create-Proxies", "latest");

    // Get proxy addresses
    cINR = contracts.deployed("StableTokenINRProxy");
