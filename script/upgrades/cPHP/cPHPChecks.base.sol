...
contract cPHPChecksBase is GovernanceScript, Test {
  using TradingLimits for TradingLimits.Config;
  using FixidityLib for FixidityLib.Fraction;
  using SafeMath for uint256;

  address public cUSD;
  address payable public cPHP;
  ...
  function setUp() public {
    ...
    contracts.loadSilent("cPHP-00-Create-Proxies", "latest");

    // Get proxy addresses
    cPHP = contracts.deployed("StableTokenPHPProxy");
